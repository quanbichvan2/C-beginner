    ...
    internal class Context
    {
        ...
        public static int Menu()
        {
            ...
            string menu = @"
                    ...
                    ||        7. Xuất Điểm Max                          ||
                    ||        8. Điểm Trung Bình                        ||
                    ||        9. Xuất Học Viên Trên Điểm Trung Bình     ||
                    ||        10.Tổng Số Học Viên                       ||
            ...
            Console.ResetColor();
            CenterWrite(6); Console.WriteLine("Nhập: ");
        ...
        {
            Console.SetCursorPosition((width - 31) / 2, Console.CursorTop);//13 là độ dài chuỗi "Chưa có cơ sở dữ liệu sinh viên"
